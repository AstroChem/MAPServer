from flask import render_template, session, redirect, url_for, current_app, g, send_from_directory
from . import main
...
def send_file(filename):
    return send_from_directory("/Users/ianczekala/Documents/MAPS/NRAO/IMLup/C18O/",
